...
<div class="container mt-5">
    ...
    <div class="d-flex gap-3 mb-4 border-bottom pb-3"> 
        ...
        <a href="crud_master_pelanggan.php" class="btn btn-dark btn-sm active">👥 Master Pelanggan</a> <a href="payroll_komponen.php" class="btn btn-outline-dark btn-sm">💵 Pengaturan Payroll</a>
    </div>
